                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <div
                                                        ...
                                                        <img src="{{ asset('assets\images/demos/demo-main.jpg') }}" alt=""
                                                            class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/demos/demo-dark.jpg') }}" alt=""
                                                            class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/demos/demo-horizontal.jpg') }}"
                                                            alt="" class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/demos/demo-minisidebar.jpg') }}"
                                                            alt="" class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/demos/demo-rtl.jpg') }}" alt=""
                                                            class="img-fluid">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="row justify-content-between">
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/apps/app-calendar.jpg') }}"
                                                            alt="" class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/apps/app-chat.jpg') }}" alt=""
                                                            class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/apps/app-email.jpg') }}" alt=""
                                                            class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/apps/app-contact.jpg') }}"
                                                            alt="" class="img-fluid">
                                                ...
                                                <div class="col">
                                                    <div
                                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                                        <img src="{{ asset('assets\images/apps/app-invoice.jpg') }}"
                                                            alt="" class="img-fluid">
                            ...
                            <div class="hero-content my-11 my-xl-0">
                                <h6 class="d-flex align-items-center gap-2 fs-4 fw-semibold mb-3" data-aos="fade-up"
                                    data-aos-delay="200" data-aos-duration="1000"><i
                                        class="ti ti-rocket text-secondary fs-6"></i>Kick start your project with</h6>
                                <h1 class="fw-bolder mb-8 fs-13" data-aos="fade-up" data-aos-delay="400"
                                    data-aos-duration="1000">Most powerful & <span class="text-primary"> Developer
                                        friendly</span>
                                    dashboard</h1>
                                <p class="fs-5 mb-5 text-dark fw-normal" data-aos="fade-up" data-aos-delay="600"
                                    data-aos-duration="1000">Modernize comes with light & dark color skins, well
                                    designed
                                ...
                                <div class="d-flex flex-row">
                                    <div class="">
                                        <div class="banner-img-1 slideup">
                                            <img src="{{ asset('assets\images/hero-img/bannerimg1.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="banner-img-1 slideup">
                                            <img src="{{ asset('assets\images/hero-img/bannerimg1.svg') }}" alt=""
                                    ...
                                    <div class="">
                                        <div class="banner-img-2 slideDown">
                                            <img src="{{ asset('assets\images/hero-img/bannerimg2.svg') }}" alt=""
                                                class="img-fluid">
                                        </div>
                                        <div class="banner-img-2 slideDown">
                                            <img src="{{ asset('assets\images/hero-img/bannerimg2.svg') }}" alt=""
                                    ...
                                    <li class="">
                                        <a class="d-block" href="javascript:void(0)">
                                            <img src="{{ asset('assets\images/profile/user-1.jpg') }}" alt=""
                                                class="img-fluid border border-2 rounded-circle border-white" width="32"
                                                height="32">
                                        </a>
                                    </li>
                                    <li class="ms-n2">
                        ...
                        <div class="demos-view mt-11 pt-lg-8">
                            <div class="row justify-content-center">
                                ...
                                <div class="col-sm-6 col-lg-4 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/demos/demo-horizontal.jpg') }}" alt=""
                                            class="img-fluid">
                                        <a target="_blank" href="../package/html/horizontal/index.html"
                                            class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                ...
                                <div class="col-sm-6 col-lg-4 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/demos/demo-minisidebar.jpg') }}" alt=""
                                            class="img-fluid">
                                        <a target="_blank" href="../package/html/minisidebar/index.html"
                                            class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                        ...
                        <div class="demos-view mt-4">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-calendar.jpg') }}" alt=""
                                            class="img-fluid">
                                        <a target="_blank" href="../package/html/main/app-calendar.html"
                                            class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-contact.jpg') }}" alt=""
                                            class="img-fluid">
                                        <a target="_blank" href="../package/html/main/app-contact2.html"
                                            class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-invoice.jpg') }}" alt=""
                                            class="img-fluid">
                                        <a target="_blank" href="../package/html/main/app-invoice.html"
                                            class="btn btn-primary lp-demos-btn fs-3 px-7 py-1 rounded position-absolute top-50 start-50 translate-middle">Live
                                            Preview</a>
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/modernize-bt-app-contact-list.jpg') }}"
                                            alt="" class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-user-profile.jpg') }}" alt=""
                                            class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/modernize-vue-app-blog.jpg') }}" alt=""
                                            class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/modernize-vue-app-blog-detail.jpg') }}"
                                            alt="" class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/modernize-vue-app-shop.jpg') }}" alt=""
                                            class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-ecommerce-detail.jpg') }}" alt=""
                                            class="img-fluid">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-8">
                                    <div
                                        class="border d-block rounded-1 mb-2 position-relative lp-demos-box overflow-hidden">
                                        <img src="{{ asset('assets\images/apps/app-ecommerce-list.jpg') }}" alt=""
                                            class="img-fluid">
                                        ...
                                        <div class="d-flex justify-content-between mb-4">
                                            ...
                                            <div>
                                                <ul
                                                    ...
                                                    <li>
                                                        <a href="">
                                                            <img src="{{ asset('assets\images/svgs/icon-star.svg') }}"
                                                                alt="" class="img-fluid">
                                                        </a>
                                                    </li>
                                                    <li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1000"
                            ...
                            <div class="text-center mb-5">
                                ...
                                <p class="mb-0 text-dark">Lots of Icon Fonts are included here in the package of Elegant
                                    Admin.</p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1000"
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1200"
                            ...
                            <div class="text-center mb-5">
                                ...
                                <p class="mb-0 text-dark">You name it and we have it, Yes lots of variations for Charts.
                                </p>
                            </div>
                        </div>
                        <div class="col-sm-6 col-md-4 col-lg-3" data-aos="fade-up" data-aos-delay="1200"
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="col-lg-5 col-xl-5">
                            <div class="text-center text-lg-end">
                                <img src="{{ asset('assets\images/backgrounds/business-woman-checking-her-mail.png') }}"
                                    alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                ...
                <ul class="navbar-nav justify-content-end flex-grow-1">
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center justify-content-between fs-3 text-dark"
                            href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Demos <i
                                class="ti ti-chevron-down fs-14"></i></a>
                    ...
                    <li class="nav-item mt-3 dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center justify-content-between fs-3 text-dark"
                            href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"> Pages <i
                                class="ti ti-chevron-down fs-14"></i></a>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="position-relative">
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-chat.svg') }}" alt=""
                                        ...
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-invoice.svg') }}" alt=""
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                            <div class="d-inline-block">
                                        ...
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-mobile.svg') }}" alt=""
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                            <div class="d-inline-block">
                                ...
                                <div class="col-12">
                                    <div class="position-relative">
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-cart.svg') }}" alt=""
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                            <div class="d-inline-block">
                                        ...
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-date.svg') }}" alt=""
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                            <div class="d-inline-block">
                                        ...
                                        <a href="#" class="d-flex align-items-center pb-7 position-relative lh-base">
                                            <div
                                                class="bg-light rounded me-3 p-6 d-flex align-items-center justify-content-center">
                                                <img src="{{ asset('assets\images/svgs/icon-dd-lifebuoy.svg') }}" alt=""
                                                    class="img-fluid" width="24" height="24">
                                            </div>
                                            <div class="d-inline-block">
                                ...
                                <div class="col-12">
                                    ...
                                    <ul class="list-unstyled px-1">
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" href="#">Pricing
                                                Page</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" href="#">Authentication
                                                Design</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" href="#">Register
                                                Now</a>
                                        </li>
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" href="#">404 Error
                                                Page</a>
                                        </li>
                                        <li class="mb-3">
                                        ...
                                        <li class="mb-3">
                                            <a class="fw-semibold text-dark text-hover-primary" href="#">Account
                                                Settings</a>
                                        </li>
                                    </ul>
                                </div>
